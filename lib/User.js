<<<<<<< HEAD
const { User, ExperienceLevel, Objective, Strategy, Workout, UserStats } = require('../database/models')
=======
...
<<<<<<< HEAD
        UserStats.update({ weight }, { where: { user_id: this._userId } })
        ExperienceLevel.update({ xp_level: xpLevel }, { where: { user_id: this._userId } })
        Objective.update({ objective }, { where: { user_id: this._userId } })
        Strategy.update({ strategy }, { where: { user_id: this._userId } })
=======
